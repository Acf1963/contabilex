...
SECRET_KEY = 'django-insecure-9-c$vdm4hb)x3d+!oae#8e=^5^$v_wb&-9*ay1$)y*iez!m=s^'
...
# PWA Settings
PWA_APP_NAME = 'Minha Contabilidade'
PWA_APP_DESCRIPTION = "Aplicação de Contabilidade Web e Offline"
